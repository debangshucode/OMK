...
function LoginModal({ onClose, onSuccess }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginModal.useEffect": ()=>{
            ...
            const getOffsetX = {
                "LoginModal.useEffect.getOffsetX": (e)=>{
            ...
            }["LoginModal.useEffect.getOffsetX"];
            const onMove = {
                "LoginModal.useEffect.onMove": (e)=>{
            ...
            }["LoginModal.useEffect.onMove"];
            const onEnd = {
                "LoginModal.useEffect.onEnd": ()=>{
                    if (!isDragging) return;
                    isDragging = false;
            ...
            const addListeners = {
                "LoginModal.useEffect.addListeners": ()=>{
            ...
            const removeListeners = {
                "LoginModal.useEffect.removeListeners": ()=>{
            ...
            const onStart = {
                "LoginModal.useEffect.onStart": (e)=>{
                    isDragging = true;
                    addListeners();
                }
            }["LoginModal.useEffect.onStart"];
...
_s(LoginModal, "xDocNJIXCMOV6lOqd5Hkn9yxcJc=");
_c = LoginModal;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$loginModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/loginModal.tsx [app-client] (ecmascript)"); // adjust path
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
_s(HeaderActions, "uVlnG5KLfXemZk5i5Fl+Cg356FU=");
_c = HeaderActions;
...
const BookingAssistant = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BookingAssistant.useEffect": ()=>{
            fetch("/lottie/animation.json").then({
                "BookingAssistant.useEffect": (res)=>res.json()
            }["BookingAssistant.useEffect"]).then(setAnimationData);
        }
    }["BookingAssistant.useEffect"], []);
        ...
        "BookingAssistant.useEffect": ()=>{
            const cycle = {
                "BookingAssistant.useEffect.cycle": ()=>{
                    ...
                    }["BookingAssistant.useEffect.cycle"], 6000);
                }
            }["BookingAssistant.useEffect.cycle"];
            cycle(); // Initial show
...
_s(BookingAssistant, "dZFBdDDx41AVNW4ERkk9EiU0e6M=");
_c = BookingAssistant;
...
//# sourceMappingURL=src_components_18ed5d44._.js.map