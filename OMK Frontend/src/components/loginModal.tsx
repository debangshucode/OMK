...
export default function LoginModal({ onClose, onSuccess }: LoginModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[999] bg-black/50 flex items-center justify-center">
      ...
      <div className="relative z-10 bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl p-10 rounded-2xl max-w-md w-full text-white">
        ...
        >
          ...
          >
            ...
            <div className="absolute right-3 top-1/2 -translate-y-1/2 text-white opacity-80">
              <Camera size={18} />
            </div>
